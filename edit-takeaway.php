                        ...
                        <form action="includes/add-order.php" method="post">
                            ...
                            <div class="my-profile">
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $sql_item_quantity = "SELECT * from takeaway where payment_id='$p_id' && item_id='$it_id' ";
                            ...
                            <button name="edittakeaway" type="submit" class="button margin-top-15">Update Order</button>
                        </form>

...
while ($row1 = $result1->fetch_assoc()) {
    ...
    $order_query = "SELECT * from place_order where payment_id = '$p_id' ";
    $result = $conn->query($order_query);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $tid = $row['table_id'];
            $sql1 = "SELECT * from booking_table where id='$tid'";
            $result1 = $conn->query($sql1);
            if ($result1->num_rows > 0) {
                while ($rows = $result1->fetch_assoc()) {
                    $table_number = $rows['table_number'];
                    $table_shape = $rows['shape'];
                    $total_number_of_person = $rows['person'];
                }
            }
        }
    }
                    ...
                    <div class="dashboard-list-box-static">
                        ...
                        <form action="includes/add-order.php" method="post">
                            ...
                            <div class="my-profile">
                                ...
                                <input disabled type="text" value='<?php echo 'Table '.$table_number.' '.$table_shape.' Person '.$total_number_of_person ?>'>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $sql_item_quantity = "SELECT * from place_order where payment_id='$p_id' && item_id='$it_id' ";
                                ...
                                <input name='table' value='<?php echo $t_able ?>' type="hidden">
                            ...
                            <button name="editorder" type="submit" class="button margin-top-15">Update Order</button>
                        </form>

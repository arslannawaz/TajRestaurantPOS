        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="dashboard-list-box margin-top-0">
                    <h4>View Takeaway Detail</h4>
                    <ul>
                        <?php
                        $sql_payment = "SELECT * from payment where status=2 order by id desc";
                            ...
                            while ($row1 = $result1->fetch_assoc()) {
                                ...
                                <li>
                                    ...
                                    <div class="buttons-to-right">
                                        <a target="_blank" href="print-takeaway-receipt.php?order_id=<?php echo $p_id ?>"  class="button gray reject"> View Receipt</a>
                                        <a href="edit-takeaway.php?order_id=<?php echo $p_id ?>" class="button gray approve">Edit</a>
                                    </div>
                                </li>
